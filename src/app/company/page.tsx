  ...
  useEffect(() => {
    ...
    const initMap = () => {
      if (typeof window !== 'undefined' && window.kakao && window.kakao.maps) {
        ...
        drawDaumMap("Seoul_map", "NEXT.CLINIC", "37.535299", "127.010828", 1);
        drawDaumMap("Sejong_map", "NEXT.CLINIC 세종", "36.49096883172943", "127.32692256110721", 3);
      }
    };
        ...
        <div className={styles.content}>
          <div className={styles.pageTitleWrap}>
            ...
            <p className={styles.pageDesc}>
              <em className={styles.vaivColor}>NEXT.CLINIC</em>는 의료 빅데이터로 건강을 읽고 AI로 의료 혁신을 만들어 갑니다.
            </p>
          </div>

          <div className={styles.conwrap}>
            <figure className={styles.companyVisual}>
              <img src="/images/main/visual_vaiv_gem_img.svg" alt="NEXT.CLINIC 회사 소개 이미지" />
            </figure>
                  ...
                  <div className={styles.colMd12}>
                    <div>
                      ...
                      <p className={styles.subTitle}>
                        NEXT.CLINIC는 의료의 맥락을 이해하고, 의료진과 환자들의 경험을 생각합니다. <br />
                ...
                <div className={styles.row}>
                  <div className={styles.colMd12}>
                    <div>
                      <div className={styles.biSection}>
                        <img src="/images/vaiv/company_ci_re.png" alt="NEXT.CLINIC BI 로고" className={styles.biLogo} />
                      </div>

                      <div className={styles.biSection}>
                        <p className={styles.biText}>
                          NEXT.CLINIC 컴퍼니는 독보적인 의료 AI 기술을 기반으로 <br className={styles.onlyMo} />
                  ...
                  <div className={`${styles.colMd12} ${styles.visionArea}`}>
                    ...
                    <div>
                      ...
                      <div className={styles.biSection}>
                        <p className={styles.biText}>NEXT.CLINIC의 의료 AI 기술로 환자의 소중한 건강을 더 가치있게 만들겠습니다.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className={styles.colMd12}>
                    <div>
                      ...
                      <div className={styles.roadSection}>
                        <div>
                          <p className={styles.title}>NEXT.CLINIC 본사 (Seoul)</p>
                          <div id="Seoul_map" className={styles.mapArea}></div>
                          <ul>
                            <li>서울 용산구 독서당로 97</li>
                            <li>TEL | 02-565-0531 FAX | 02-565-0532 E-mail | Biz@NEXT.CLINIC.kr</li>
                          </ul>
                        </div>

                        <div>
                          <p className={styles.title}>NEXT.CLINIC 세종 (Sejong)</p>
